<footer class="relative bg-slate-900 pt-24 pb-12 overflow-hidden">
    ...
    {{-- Memberikan kesan modern dan tidak "flat" --}}
    <div class="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-lg h-48 bg-primary-600/10 blur-[100px] rounded-full pointer-events-none"></div>
    ...
    <div class="container mx-auto px-4 text-center relative z-10">
        ...
        <div class="mb-8" data-aos="fade-up">
            ...
            {{-- Nama Anak (Brand Utama) --}}
            <h2 class="font-esthetic text-5xl md:text-7xl text-white drop-shadow-lg mb-2">
                {{ $event->child_name }}
            </h2>
        ...
        {{-- Garis Pemisah --}}
        <div class="w-full max-w-xs mx-auto h-px bg-gradient-to-r from-transparent via-slate-700 to-transparent my-8"></div>
