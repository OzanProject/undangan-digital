...
<div id="acara" class="container mx-auto px-4">
    ...
    {{-- Main Card --}}
    <div class="max-w-5xl mx-auto bg-white rounded-3xl shadow-xl overflow-hidden border border-stone-200 flex flex-col md:flex-row" 
        data-aos="fade-up" data-aos-delay="100">
        
        {{-- Kiri: Detail Informasi --}}
        <div class="w-full md:w-5/12 p-8 md:p-10 flex flex-col justify-center bg-white relative z-10">
            
            <h3 class="font-sans text-3xl text-stone-700 mb-8 text-center md:text-left font-bold">
                Syukuran Khitan
            </h3>
            ...
            <div class="space-y-8">
                ...
                <div class="flex items-start gap-4">
                    {{-- Ikon: Aksen Abu-abu Tua --}}
                    <div class="flex-shrink-0 w-12 h-12 rounded-xl bg-stone-100 text-stone-700 flex items-center justify-center shadow-inner shadow-stone-200/50">
            ...
            <div class="mt-10 space-y-3">
                ...
                {{-- 1. Tombol Google Maps (Aksen Hijau Zaitun) --}}
                <a href="https://maps.google.com/?q={{ urlencode($event->location_name . ' ' . $event->location_address) }}" 
                    target="_blank"
                    class="block w-full text-center py-3 px-6 rounded-xl bg-lime-700 text-white font-semibold shadow-xl shadow-lime-300/40 hover:bg-lime-600 hover:shadow-2xl transition-all transform hover:-translate-y-0.5 group">
                ...
                {{-- 2. Tombol Add to Calendar (Aksen Abu-abu) --}}
                <div class="grid grid-cols-2 gap-3">
                    {{-- Google Calendar --}}
                    <a href="{!! $googleUrl !!}" target="_blank"
                        class="flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl bg-white border border-stone-300 text-slate-600 text-sm font-bold hover:bg-stone-100 hover:text-stone-700 hover:border-stone-400 transition-all">
        ...
        <div class="w-full md:w-7/12 h-80 md:h-auto relative bg-stone-100">
            @if($event->maps_iframe)
                <iframe 
                    ...
                    {{-- Filter grayscale untuk kesan minimalis --}}
