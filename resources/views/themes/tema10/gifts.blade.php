<div id="gifts" class="container mx-auto px-4">
    ...
    <div class="flex flex-wrap justify-center gap-6 md:gap-8">
        ...
        {{-- BANK 1 (Deep Magenta Dark Theme) --}}
        @if($event->bank_name_1)
        <div class="relative w-full max-w-md group perspective" data-aos="flip-up" data-aos-delay="100">
            {{-- Gradient Magenta Tua/Dark --}}
            <div class="relative h-56 bg-gradient-to-br from-fuchsia-700 via-fuchsia-800 to-stone-900 rounded-2xl shadow-xl text-white p-6 flex flex-col justify-between overflow-hidden border border-fuchsia-600/50 transition-transform duration-500 group-hover:-translate-y-2">
                ...
                <div class="relative z-10 mt-2">
                    {{-- Chip: Mint Cerah --}}
                    <div class="w-12 h-9 bg-gradient-to-tr from-emerald-300 to-emerald-100 rounded mb-4 opacity-90 flex items-center justify-center">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        {{-- Tombol Copy: Aksen Mint Muda --}}
                        <button 
                            type="button"
                            onclick="copyToClipboard('rek1', this)" 
                            class="text-emerald-300 hover:text-white transition-colors" 
                            title="Salin Nomor"
                        >
                ...
                <div class="relative flex justify-between items-end z-10">
                    <div>
                        <p class="text-[10px] text-emerald-300 uppercase tracking-widest mb-0.5">Card Holder</p>
        ...
        {{-- BANK 2 (Light Mint Theme) --}}
        @if($event->bank_name_2)
        <div class="relative w-full max-w-md group perspective" data-aos="flip-up" data-aos-delay="200">
            {{-- Latar Belakang Mint Terang --}}
            <div class="relative h-56 bg-gradient-to-br from-emerald-100 via-emerald-200 to-emerald-300 rounded-2xl shadow-xl text-slate-800 p-6 flex flex-col justify-between overflow-hidden border border-fuchsia-500 transition-transform duration-500 group-hover:-translate-y-2">
                ...
                <div class="relative z-10 mt-2">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        {{-- Tombol Copy: Aksen Magenta Tua --}}
                        <button 
                            type="button"
                            onclick="copyToClipboard('rek2', this)" 
                            class="text-fuchsia-700 hover:text-fuchsia-800 transition-colors" 
                            title="Salin Nomor"
                        >
                            <i class="bi bi-copy"></i>
                        </button>
                ...
                <div class="relative flex justify-between items-end z-10">
                    <div>
                        <p class="text-[10px] text-fuchsia-700 uppercase tracking-widest mb-0.5">Card Holder</p>
                        <p class="font-medium tracking-wide uppercase text-sm md:text-base">
                            {{ $event->bank_holder_2 }}
                        </p>
                    </div>
