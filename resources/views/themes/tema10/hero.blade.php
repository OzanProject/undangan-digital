...
>
    ...
    >
        ...
        <div data-aos="fade-down" data-aos-duration="1000" class="w-full text-center mt-1">
            <p class="text-emerald-300 text-[10px] md:text-xs font-medium tracking-[0.3em] uppercase mb-2">
                Kepada Yth. Bapak/Ibu/Saudara/i
            </p>
            
            {{-- Badge: background transparan gelap dengan border Mint lembut --}}
            <div class="inline-block bg-stone-800/50 backdrop-blur-sm border border-emerald-300/50 rounded-full px-6 py-2 shadow-2xl">
        ...
        <div class="w-full px-2 text-center">
            ...
            {{-- Nama: Font Sans Bold dan Aksen Magenta --}}
            <h1 class="font-sans text-4xl md:text-5xl lg:text-6xl text-fuchsia-300 mt-2 mb-3 md:mb-5 drop-shadow-2xl" 
                data-aos="zoom-in" 
                data-aos-delay="400"
                {{-- Efek shadow Magenta Cerah --}}
                style="text-shadow: 0 0 20px rgba(236, 72, 153, 0.6); line-height: 1.1; font-weight: 800;"
            >
                {{ $event->child_name }}
            </h1>
        </div>
    ...
    {{-- D. TOMBOL BUKA UNDANGAN (Aksen Magenta Tua) --}}
    <div class="absolute inset-x-0 bottom-6 flex justify-center z-20 px-4">
        <a 
            ...
            class="btn-buka btn-buka-enter group relative inline-flex items-center justify-center 
                    ...
                    transition-all duration-300 bg-fuchsia-700 rounded-full 
                    hover:bg-fuchsia-600 hover:shadow-[0_0_25px_rgba(206,147,216,0.6)] 
                    hover:-translate-y-1 active:scale-95 shadow-xl shadow-fuchsia-900/50"
        >
