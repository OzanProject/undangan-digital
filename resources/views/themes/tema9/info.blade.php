...
<div id="acara" class="container mx-auto px-4">
    ...
    {{-- Main Card --}}
    <div class="max-w-5xl mx-auto bg-white rounded-3xl shadow-xl overflow-hidden border border-amber-200 flex flex-col md:flex-row" 
        data-aos="fade-up" data-aos-delay="100">
        
        {{-- Kiri: Detail Informasi --}}
        <div class="w-full md:w-5/12 p-8 md:p-10 flex flex-col justify-center bg-white relative z-10">
            
            <h3 class="font-serif-classic text-3xl text-amber-900 mb-8 text-center md:text-left">
                Syukuran Khitan
            </h3>
            ...
            <div class="space-y-8">
                ...
                <div class="flex items-start gap-4">
                    {{-- Ikon: Aksen Coklat Tua --}}
                    <div class="flex-shrink-0 w-12 h-12 rounded-xl bg-amber-100 text-amber-900 flex items-center justify-center shadow-inner shadow-amber-300/50">
                        <i class="bi bi-calendar-heart-fill text-xl"></i>
                    </div>
                    <div>
                        <p class="text-sm text-stone-500 font-medium uppercase tracking-wider mb-1">Hari & Tanggal</p>
                        <p class="text-lg font-bold text-stone-800 capitalize">
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        <p class="text-sm text-stone-500 font-medium uppercase tracking-wider mb-1">Pukul</p>
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        <p class="text-sm text-stone-500 font-medium uppercase tracking-wider mb-1">Lokasi Acara</p>
                        <p class="text-lg font-bold text-stone-800 leading-tight mb-1">
                            {{ $event->location_name }}
                        </p>
            ...
            <div class="mt-10 space-y-3">
                ...
                {{-- 1. Tombol Google Maps (Aksen Coklat Tua) --}}
                <a href="https://maps.google.com/?q={{ urlencode($event->location_name . ' ' . $event->location_address) }}" 
                    target="_blank"
                    class="block w-full text-center py-3 px-6 rounded-xl bg-amber-900 text-white font-semibold shadow-xl shadow-amber-300/40 hover:bg-amber-800 hover:shadow-2xl transition-all transform hover:-translate-y-0.5 group">
                ...
                <div class="relative flex py-2 items-center">
                    ...
                    <span class="flex-shrink-0 mx-4 text-stone-500 text-xs uppercase font-bold">Simpan Tanggal</span>
                    <div class="flex-grow border-t border-stone-300"></div>
                </div>

                {{-- 2. Tombol Add to Calendar (Aksen Coklat) --}}
                <div class="grid grid-cols-2 gap-3">
                    {{-- Google Calendar --}}
                    <a href="{!! $googleUrl !!}" target="_blank"
                        class="flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl bg-white border border-amber-300 text-stone-600 text-sm font-bold hover:bg-amber-100 hover:text-amber-900 hover:border-amber-400 transition-all">
        ...
        <div class="w-full md:w-7/12 h-80 md:h-auto relative bg-stone-200">
            ...
            @else
                <div class="w-full h-full flex flex-col items-center justify-center text-stone-400 space-y-2 p-6 text-center">
