<div id="gifts" class="container mx-auto px-4">
    ...
    <div class="text-center mb-12" data-aos="fade-up">
        ...
        <p class="text-stone-600 mt-3 font-light">
    ...
    <div class="flex flex-wrap justify-center gap-6 md:gap-8">
        ...
        {{-- BANK 1 (Deep Coklat Theme) --}}
        @if($event->bank_name_1)
        <div class="relative w-full max-w-md group perspective" data-aos="flip-up" data-aos-delay="100">
            {{-- Gradient Coklat Tua/Dark --}}
            <div class="relative h-56 bg-gradient-to-br from-amber-800 via-amber-900 to-stone-900 rounded-2xl shadow-xl text-white p-6 flex flex-col justify-between overflow-hidden border border-amber-800/50 transition-transform duration-500 group-hover:-translate-y-2">
                ...
                <div class="relative z-10 mt-2">
                    {{-- Chip: Krem Hangat --}}
                    <div class="w-12 h-9 bg-gradient-to-tr from-stone-300 to-stone-100 rounded mb-4 opacity-90 flex items-center justify-center">
        ...
        {{-- BANK 2 (Light Krem Theme) --}}
        @if($event->bank_name_2)
        <div class="relative w-full max-w-md group perspective" data-aos="flip-up" data-aos-delay="200">
            {{-- Latar Belakang Krem Terang --}}
            <div class="relative h-56 bg-gradient-to-br from-stone-100 via-stone-200 to-stone-300 rounded-2xl shadow-xl text-stone-800 p-6 flex flex-col justify-between overflow-hidden border border-amber-500 transition-transform duration-500 group-hover:-translate-y-2">
                ...
                <div class="relative flex justify-between items-end z-10">
                    <div>
                        <p class="text-[10px] text-amber-800 uppercase tracking-widest mb-0.5">Card Holder</p>
                        <p class="font-medium tracking-wide uppercase text-sm md:text-base">
                            {{ $event->bank_holder_2 }}
                        </p>
                    </div>
