<footer class="relative bg-slate-900 pt-24 pb-12 overflow-hidden">
    ...
    {{-- Efek Cahaya Latar Belakang (Glow Effect Pink) --}}
    <div class="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-lg h-48 bg-pink-600/10 blur-[100px] rounded-full pointer-events-none"></div>
    ...
    <div class="container mx-auto px-4 text-center relative z-10">
        ...
        {{-- Garis Pemisah (Aksen Pink di tengah) --}}
        <div class="w-full max-w-xs mx-auto h-px bg-gradient-to-r from-transparent via-pink-600 to-transparent my-8"></div>
