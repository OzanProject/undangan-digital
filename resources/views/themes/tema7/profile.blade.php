<div id="mempelai" class="container mx-auto px-4 relative z-10">
    ...
    <div class="text-center max-w-3xl mx-auto mb-12" data-aos="fade-up">
        <span class="text-pink-600 font-bold tracking-wider uppercase text-xs md:text-sm mb-2 block">
            Tasyakur Khitan
        </span>
        {{-- Font Sans --}}
    ...
    <div class="relative max-w-4xl mx-auto" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="relative z-10 bg-white rounded-[2.5rem] shadow-2xl p-8 md:p-12 text-center border border-pink-50">
            ...
            <div class="relative inline-block mb-8">
                {{-- Lingkaran Dekorasi di belakang foto (Aksen Pink) --}}
                <div class="absolute inset-0 bg-pink-100/70 rounded-full scale-110 animate-pulse-slow"></div> 
                ...
                {{-- Ikon Hiasan kecil (Aksen Pink Tua) --}}
                <div class="absolute bottom-2 right-2 bg-pink-600 text-white w-10 h-10 rounded-full flex items-center justify-center shadow-lg border-2 border-white">
            ...
            {{-- Nama & Orang Tua --}}
            <div class="space-y-4">
                {{-- Nama Anak (Font Sans & Aksen Pink Tua) --}}
                <h3 class="font-sans text-5xl md:text-6xl text-pink-600 drop-shadow-sm font-extrabold">
                    {{ $event->child_name }}
                </h3>
                ...
                @if(!empty($event->turut_mengundang_ayah) || !empty($event->turut_mengundang_ibu))
                    ...
                    <div class="mt-10 pt-8 border-t border-dashed border-pink-200 w-full max-w-2xl mx-auto">
                        <p class="text-xs font-bold text-pink-600 uppercase tracking-[0.2em] mb-6">
                            Turut Mengundang
                        </p>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 text-center md:text-left">
                            ...
                            <div>
                                <h4 class="font-semibold text-pink-600 mb-3 text-base uppercase tracking-wide">
                                    Kel. Besar Bapak
                                </h4>
            ...
            {{-- Alamat (Aksen Hover Pink) --}}
            <div class="mt-10 inline-flex items-center justify-center gap-2 px-6 py-3 bg-pink-100 rounded-full border border-pink-300 text-sm md:text-base text-slate-600 hover:bg-pink-200 hover:border-pink-400 hover:text-pink-600 transition-colors cursor-default group">
                <i class="bi bi-geo-alt-fill text-pink-600 group-hover:scale-110 transition-transform"></i>
