<div id="gifts" class="container mx-auto px-4">
    ...
    <div class="flex flex-wrap justify-center gap-6 md:gap-8">
        ...
        {{-- BANK 1 (Deep Fuchsia Dark Theme) --}}
        @if($event->bank_name_1)
        <div class="relative w-full max-w-md group perspective" data-aos="flip-up" data-aos-delay="100">
            {{-- Gradient Fuchsia/Pink Dark --}}
            <div class="relative h-56 bg-gradient-to-br from-fuchsia-600 via-fuchsia-700 to-slate-900 rounded-2xl shadow-xl text-white p-6 flex flex-col justify-between overflow-hidden border border-pink-600/50 transition-transform duration-500 group-hover:-translate-y-2">
        ...
        {{-- BANK 2 (Light Pink Theme) --}}
        @if($event->bank_name_2)
        <div class="relative w-full max-w-md group perspective" data-aos="flip-up" data-aos-delay="200">
            {{-- Latar Belakang Pink Terang --}}
            <div class="relative h-56 bg-gradient-to-br from-pink-100 via-pink-200 to-pink-300 rounded-2xl shadow-xl text-slate-800 p-6 flex flex-col justify-between overflow-hidden border border-pink-400 transition-transform duration-500 group-hover:-translate-y-2">
                ...
                <div class="relative flex justify-between items-end z-10">
                    <div>
                        <p class="text-[10px] text-pink-600 uppercase tracking-widest mb-0.5">Card Holder</p>
                        <p class="font-medium tracking-wide uppercase text-sm md:text-base">
                            {{ $event->bank_holder_2 }}
                        </p>
                    </div>
