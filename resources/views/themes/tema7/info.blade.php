...
<div id="acara" class="container mx-auto px-4">
    ...
    {{-- Main Card --}}
    <div class="max-w-5xl mx-auto bg-white rounded-3xl shadow-xl overflow-hidden border border-pink-200 flex flex-col md:flex-row" 
        data-aos="fade-up" data-aos-delay="100">
        
        {{-- Kiri: Detail Informasi --}}
        <div class="w-full md:w-5/12 p-8 md:p-10 flex flex-col justify-center bg-white relative z-10">
            
            <h3 class="font-sans text-3xl text-pink-600 mb-8 text-center md:text-left font-bold">
                Syukuran Khitan
            </h3>
            ...
            <div class="space-y-8">
                ...
                <div class="flex items-start gap-4">
                    {{-- Ikon: Aksen Pink Tua --}}
                    <div class="flex-shrink-0 w-12 h-12 rounded-xl bg-pink-100 text-pink-600 flex items-center justify-center shadow-inner shadow-pink-200/50">
            ...
            <div class="mt-10 space-y-3">
                ...
                {{-- 1. Tombol Google Maps (Aksen Pink Tua) --}}
                <a href="https://maps.google.com/?q={{ urlencode($event->location_name . ' ' . $event->location_address) }}" 
                    target="_blank"
                    class="block w-full text-center py-3 px-6 rounded-xl bg-pink-600 text-white font-semibold shadow-xl shadow-pink-300/40 hover:bg-pink-500 hover:shadow-2xl transition-all transform hover:-translate-y-0.5 group">
                ...
                {{-- 2. Tombol Add to Calendar (Aksen Pink) --}}
                <div class="grid grid-cols-2 gap-3">
                    {{-- Google Calendar --}}
                    <a href="{!! $googleUrl !!}" target="_blank"
                        class="flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl bg-white border border-pink-300 text-slate-600 text-sm font-bold hover:bg-pink-100 hover:text-pink-600 hover:border-pink-400 transition-all">
