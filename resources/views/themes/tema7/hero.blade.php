...
>
    ...
    >
        ...
        <div data-aos="fade-down" data-aos-duration="1000" class="w-full text-center mt-1">
            <p class="text-pink-600 text-[10px] md:text-xs font-medium tracking-[0.3em] uppercase mb-2">
                Kepada Yth. Bapak/Ibu/Saudara/i
            </p>
            
            {{-- Badge: background transparan terang dengan border pink lembut --}}
            <div class="inline-block bg-pink-100/70 backdrop-blur-sm border border-pink-300/50 rounded-full px-6 py-2 shadow-md">
        ...
        <div class="w-full px-2 text-center">
            ...
            {{-- Nama: Font Sans dan Aksen Pink Cerah --}}
            <h1 class="font-sans text-4xl md:text-5xl lg:text-6xl text-pink-600 mt-2 mb-3 md:mb-5 drop-shadow-sm" 
                data-aos="zoom-in" 
                data-aos-delay="400"
                style="text-shadow: 0 0 10px rgba(236, 72, 153, 0.4); line-height: 1.1; font-weight: 800;"
            >
                {{ $event->child_name }}
            </h1>
        </div>
    ...
    {{-- D. TOMBOL BUKA UNDANGAN (Aksen Pink Tua) --}}
    <div class="absolute inset-x-0 bottom-6 flex justify-center z-20 px-4">
        <a 
            ...
            class="btn-buka btn-buka-enter group relative inline-flex items-center justify-center 
                    ...
                    transition-all duration-300 bg-pink-600 rounded-full 
                    hover:bg-pink-500 hover:shadow-lg hover:-translate-y-1 active:scale-95 shadow-xl shadow-pink-300/50"
        >
