...
>
    ...
    >
        ...
        <div data-aos="fade-down" data-aos-duration="1000" class="w-full text-center mt-1">
            <p class="text-teal-600 text-[10px] md:text-xs font-medium tracking-[0.3em] uppercase mb-2">
                Kepada Yth. Bapak/Ibu/Saudara/i
            </p>
            
            {{-- Badge: background transparan terang dengan border toska lembut --}}
            <div class="inline-block bg-teal-100/70 backdrop-blur-sm border border-teal-300/50 rounded-full px-6 py-2 shadow-md">
        ...
        <div class="w-full px-2 text-center">
            ...
            {{-- Nama: Font Sans dan Aksen Toska Cerah --}}
            <h1 class="font-sans text-4xl md:text-5xl lg:text-6xl text-teal-600 mt-2 mb-3 md:mb-5 drop-shadow-sm" 
                data-aos="zoom-in" 
                data-aos-delay="400"
                style="text-shadow: 0 0 10px rgba(20, 184, 166, 0.4); line-height: 1.1; font-weight: 800;"
            >
                {{ $event->child_name }}
            </h1>
        </div>
    ...
    {{-- D. TOMBOL BUKA UNDANGAN (Aksen Toska Tua) --}}
    <div class="absolute inset-x-0 bottom-6 flex justify-center z-20 px-4">
        <a 
            ...
            class="btn-buka btn-buka-enter group relative inline-flex items-center justify-center 
                    ...
                    transition-all duration-300 bg-teal-600 rounded-full 
                    hover:bg-teal-500 hover:shadow-lg hover:-translate-y-1 active:scale-95 shadow-xl shadow-teal-300/50"
        >
