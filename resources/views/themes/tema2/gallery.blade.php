...
<div id="galeri" class="container mx-auto px-4">
            ...
            @foreach($galleries as $img)
                <div class="relative group" data-aos="zoom-in" data-aos-delay="{{ $loop->iteration * 100 }}">
                    ...
                    <a href="{{ asset('storage/'.$img->image) }}" 
                        ...
                        {{-- Mengganti sudut menjadi sedikit lebih lembut (rounded-xl) dan Shadow lebih dalam --}}
                        class="block w-full aspect-square overflow-hidden rounded-xl shadow-xl cursor-pointer bg-slate-200 relative border border-green-50">
                        ...
                        {{-- Overlay Hover Effect (Tetap Netral Gelap, tapi Ikon lebih menonjol) --}}
    ...
    @else
        {{-- Empty State (Aksen Hijau) --}}
        <div class="text-center py-12 bg-green-50 rounded-3xl border border-dashed border-green-300" data-aos="fade-up">
            <div class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-green-100 mb-4">
                <i class="bi bi-images text-3xl text-green-500"></i>
            </div>
