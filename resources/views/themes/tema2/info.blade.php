...
<div class="container mx-auto px-4">
    ...
    <div class="text-center mb-12" data-aos="fade-up">
        {{-- Ganti primary-600 menjadi green-700/amber-500 --}}
        <span class="text-green-700 font-bold tracking-[0.2em] uppercase text-xs md:text-sm">
            Save The Date
        </span>
        {{-- Ganti font estetik ke font elegan --}}
        <h2 class="font-serif-elegan text-4xl md:text-5xl text-slate-800 mt-2">
            Waktu & Tempat
        </h2>
    </div>

    {{-- Main Card (Lebih Elegan & Kontras) --}}
    <div class="max-w-5xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden border border-green-50 flex flex-col md:flex-row" 
        ...
        <div class="w-full md:w-5/12 p-8 md:p-10 flex flex-col justify-center bg-white relative z-10">
            ...
            {{-- Header Card --}}
            <h3 class="font-serif-elegan text-3xl text-green-800 mb-8 text-center md:text-left">
                Syukuran Khitan
            </h3>
            ...
            <div class="space-y-8">
                ...
                <div class="flex items-start gap-4">
                    {{-- Ganti primary-50/600 menjadi green-50/800 --}}
                    <div class="flex-shrink-0 w-12 h-12 rounded-xl bg-green-100 text-green-800 flex items-center justify-center shadow-inner shadow-green-200/50">
            ...
            <div class="mt-10 space-y-3">
                ...
                {{-- 1. Tombol Google Maps (Warna Utama Hijau Tua) --}}
                <a href="https://maps.google.com/?q={{ urlencode($event->location_name . ' ' . $event->location_address) }}" 
                    target="_blank"
                    class="block w-full text-center py-3 px-6 rounded-xl bg-green-800 text-white font-semibold shadow-xl shadow-green-900/40 hover:bg-green-700 hover:shadow-2xl transition-all transform hover:-translate-y-0.5 group">
                    <i class="bi bi-map-fill me-2 group-hover:animate-bounce"></i> 
                    Buka Google Maps
                </a>

                {{-- Divider Kecil (Warna lebih netral) --}}
                ...
                <div class="grid grid-cols-2 gap-3">
                    {{-- Google Calendar (Aksen Biru untuk merek Google, tetapi border & hover lebih lembut) --}}
                    <a href="{!! $googleUrl !!}" target="_blank"
                        class="flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl bg-white border border-slate-200 text-slate-600 text-sm font-bold hover:bg-slate-50 hover:text-green-800 hover:border-green-200 transition-all">
