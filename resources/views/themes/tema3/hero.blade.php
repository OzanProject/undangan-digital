...
>
    {{-- Overlay Cokelat Gelap/Gold --}}
    {{-- Latar belakang Hero harus menjadi kontras gelap --}}
    <div class="absolute inset-0 bg-stone-900/70 bg-gradient-to-b from-stone-900/95 via-stone-900/50 to-stone-900/95 z-0"></div>
    ...
    >
        ...
        <div data-aos="fade-down" data-aos-duration="1000" class="w-full text-center mt-1">
            ...
            {{-- Badge: background transparan mewah --}}
            <div class="inline-block bg-white/10 backdrop-blur-sm border border-amber-200/50 rounded-full px-6 py-2 shadow-2xl">
        ...
        <div class="w-full px-2 text-center">
            ...
            {{-- Nama: Font Classic dan Aksen Emas --}}
            <h1 class="font-serif-classic text-4xl md:text-5xl lg:text-6xl text-amber-300 mt-2 mb-3 md:mb-5 drop-shadow-2xl" 
                data-aos="zoom-in" 
                data-aos-delay="400"
                {{-- Efek shadow emas klasik --}}
                style="text-shadow: 0 0 15px rgba(253, 230, 138, 0.4); line-height: 1.1; font-weight: 500;"
            >
                {{ $event->child_name }}
            </h1>
        </div>
    ...
    {{-- D. TOMBOL BUKA UNDANGAN (Aksen Emas Tua) --}}
    <div class="absolute inset-x-0 bottom-6 flex justify-center z-20 px-4">
        <a 
            ...
            class="btn-buka btn-buka-enter group relative inline-flex items-center justify-center 
                    ...
                    transition-all duration-300 bg-amber-800 rounded-full 
                    hover:bg-amber-700 hover:shadow-[0_0_25px_rgba(251,191,36,0.6)] 
                    hover:-translate-y-1 active:scale-95 shadow-xl shadow-amber-900/50"
        >
            {{-- Efek ping emas/putih --}}
