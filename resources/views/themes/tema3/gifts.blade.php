<div id="gifts" class="container mx-auto px-4">
    ...
    <div class="flex flex-wrap justify-center gap-6 md:gap-8">
        ...
        {{-- BANK 1 (Classic Dark Gold Theme) --}}
        @if($event->bank_name_1)
        <div class="relative w-full max-w-md group perspective" data-aos="flip-up" data-aos-delay="100">
            {{-- Mengganti gradient ke Coklat/Emas Gelap --}}
            <div class="relative h-56 bg-gradient-to-br from-stone-700 via-stone-800 to-amber-900 rounded-2xl shadow-2xl text-white p-6 flex flex-col justify-between overflow-hidden border border-amber-600/50 transition-transform duration-500 group-hover:-translate-y-2">
                ...
                <div class="relative z-10 mt-2">
                    ...
                    <div class="w-12 h-9 bg-gradient-to-tr from-yellow-300 to-yellow-500 rounded mb-4 opacity-90 flex items-center justify-center">
                ...
                <div class="relative flex justify-between items-end z-10">
                    <div>
                        {{-- Text Kecil: Aksen Emas Muda --}}
                        <p class="text-[10px] text-amber-300 uppercase tracking-widest mb-0.5">Card Holder</p>
        ...
        {{-- BANK 2 (Lighter Classic Beige Theme) --}}
        @if($event->bank_name_2)
        <div class="relative w-full max-w-md group perspective" data-aos="flip-up" data-aos-delay="200">
            {{-- Mengganti gradient ke Beige/Stone yang lebih cerah, dikombinasikan dengan Gold --}}
            <div class="relative h-56 bg-gradient-to-br from-stone-500 via-stone-600 to-amber-700 rounded-2xl shadow-2xl text-white p-6 flex flex-col justify-between overflow-hidden border border-white/20 transition-transform duration-500 group-hover:-translate-y-2">
                
                {{-- Glass Overlay (Aksen Emas) --}}
                ...
                <div class="relative flex justify-between items-end z-10">
                    <div>
                        {{-- Text Kecil: Aksen Emas Pudar --}}
                        <p class="text-[10px] text-amber-200 uppercase tracking-widest mb-0.5">Card Holder</p>
                        <p class="font-medium tracking-wide uppercase text-sm md:text-base">
                            {{ $event->bank_holder_2 }}
                        </p>
                    </div>
