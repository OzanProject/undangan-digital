...
<div id="galeri" class="container mx-auto px-4">
    ...
    @else
        {{-- Empty State (Aksen Violet) --}}
        <div class="text-center py-12 bg-pink-50 rounded-3xl border border-dashed border-violet-300" data-aos="fade-up">
            <div class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-violet-100 mb-4">
                <i class="bi bi-images text-3xl text-violet-500"></i>
            </div>
